...
const COPY = {
  ...
  hearMode: '👂 Ouvir',
  answerMode: '🎯 Responder',
  tapToHear: 'Toque nas notas para ouvir. Escolha no 🎯 quando souber!',
  ...
  nowSing: '🎶 Agora cante!',
  startSinging: '🎤 Cantar!',
  tapToHear: 'Toque nas notas para ouvir. Depois toque ✓ para responder!',
  placeNote: 'Colocar',
  listening: 'Ouvindo…',
  yourVoice: 'sua voz',
...
const ES = {
  ...
  hearMode: '👂 Escuchar',
  answerMode: '🎯 Responder',
  tapToHear: 'Toca las notas para escuchar. ¡Elige en 🎯 cuando lo sepas!',
  ...
  tapToHear: '¡Toca las notas para escucharlas. Luego ✓ para responder!',
  placeNote: 'Poner',
...
const EN = {
  ...
  hearMode: '👂 Listen',
  answerMode: '🎯 Answer',
  tapToHear: 'Tap the notes to hear them. Pick on 🎯 when you know!',
  ...
  nowSing: '🎶 Now sing!',
  startSinging: '🎤 Sing!',
  tapToHear: 'Tap the notes to hear them. Then ✓ to answer!',
  placeNote: 'Place',
  listening: 'Listening…',
