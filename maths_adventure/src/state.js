// Estado do Maths Adventures — por jogadora, isolado da Geografia (spec §3/§25/§36).
...
export const STORAGE_KEY = 'mundo-da-julia.maths.v1';
...
export const QUEST_POOL = [
  ...
  { id: 'collect-forest-5', icon: '🍄', metric: 'collect:forest', target: 5 },
