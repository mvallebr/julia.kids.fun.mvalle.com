// Mapa do reino (spec §24): caminho dourado ligando os 10 mundos ao Palácio
...
const NODE_POSITIONS = [
  { x: 8, y: 74 }, { x: 20, y: 56 }, { x: 30, y: 72 }, { x: 41, y: 50 },
  { x: 52, y: 68 }, { x: 60, y: 44 }, { x: 70, y: 62 }, { x: 79, y: 40 },
  { x: 87, y: 58 }, { x: 94, y: 34 },
];
